...
public class LHController {
	...
	public static void getLHapi(Model model) throws IOException {
      ...
      // API데이터 뿌려주는 곳.
        ...
        //urlBuilder.append("&" + URLEncoder.encode("ServiceKey","UTF-8") + "=" + URLEncoder.encode("wzVGH0RoH4TBmxGKJY4GBkDozdkN0n6aQcP6R3RFMGoyjFZzW6wLW5XW1ikRufIwVjTGMxqlOguEoEMgTQUqVw%3D%3D", "UTF-8")); /*공공데이터포털에서 받은 인증키*/
